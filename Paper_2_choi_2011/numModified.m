...
[ sol.phi_star, sol.phi_1_star, sol.phi_2_star ] = ...
    ...
    data.q_1_star, data.q_2_star, data.zeta_int_star, ...
...
function [ phi_star, phi_1_star, phi_2_star ] = electricPotential(K1, K2, q_1_star, q_2_star, zeta_int_star, alpha_e, q_int_star, y1_star, y2_star)
...
A(1, 1) = -1;
A(1, 2) = 1;
b(1) = del_y1_star * q_1_star;

% Top
A(end, end-1) = -1;
A(end, end) = 1;
b(end) = -1 * del_y2_star * q_2_star;
